...
import 'animate.css'
// 引入 src/components/icon/offlineIcon.ts 文件中所有使用addIcon添加过的本地图标
import '@/components/icon/offlineIcon'
...
import BackTopIcon from '@/assets/svg/back_top.svg'
...
onBeforeMount(() => {
  console.log('$storage.layout?.overallStyle', $storage.layout?.overallStyle)
