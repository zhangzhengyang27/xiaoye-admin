...
function getStorageItem(key) {
  return storageLocal.get<optionsItem[]>(key) || []
}
...
function saveHistory() {
  ...
  if (!isCollected) {
    ...
    storageLocal.set(LOCALEHISTORYKEY, searchHistoryList)
  }
}
...
function handleDrag(item: dragItem) {
  ...
  storageLocal.set(LOCALECOLLECTKEY, searchCollectList)
