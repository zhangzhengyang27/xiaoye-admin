...
import IconifyIconOffline from '@/components/icon/iconifyIconOffline.ts'
import {
  Reload,
  Upload,
  ArrowH,
      ...
      setup() {
        return () => (
          <div class="flex flex-wrap w-[60px] justify-between">
            ...
            <span onClick={() => downloadByBase64(imgBase64.value, 'cropping.png')}>
              <IconifyIconOffline
                class={iconClass.value}
                v-tippy={{
                  content: '下载',
            ...
            <span onClick={() => handCropper('reset')}>
              <IconifyIconOffline
                class={iconClass.value}
                v-tippy={{
                  content: '重置',
            ...
            <span onClick={() => handCropper('scaleX', -1)}>
              <IconifyIconOffline
                class={iconClass.value}
                v-tippy={{
                  content: '水平翻转',
            ...
            <span onClick={() => handCropper('scaleY', -1)}>
              <IconifyIconOffline
                class={iconClass.value}
                v-tippy={{
                  content: '垂直翻转',
            ...
            <span onClick={() => handCropper('rotate', -45)}>
              <IconifyIconOffline
                class={iconClass.value}
                v-tippy={{
                  content: '逆时针旋转',
