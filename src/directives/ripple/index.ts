...
const calculate = (e: PointerEvent, el: HTMLElementWithRipple, value: RippleOptions = {}) => {
...
const ripples = {
  show(e: PointerEvent, el: HTMLElementWithRipple, value: RippleOptions = {}) {
  ...
  hide(el: HTMLElementWithRipple | null) {
...
function rippleShow(e: PointerEvent) {
  ...
  const element = e.currentTarget as HTMLElementWithRipple | undefined
...
function rippleHide(e: Event) {
  const element = e.currentTarget as HTMLElementWithRipple | null
...
function updateRipple(el: HTMLElementWithRipple, binding: RippleDirectiveBinding, wasEnabled: boolean) {
...
function unmounted(el: HTMLElementWithRipple) {
  delete el._ripple
  removeListeners(el)
}
