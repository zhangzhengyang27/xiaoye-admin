<template>
  <el-card shadow="never">
    ...
    <p v-show="fileList.length > 0" class="mb-4">{{ imgInfos }}</p>
    <el-upload
...
/**
 * 图片拖拽排序功能
 * @param {string} uid - 当前拖拽图片的唯一标识
 * @description 使用SortableJS实现图片列表的拖拽排序功能，处理拖拽结束后的列表更新和样式清除
 * @note 修复了Chromium浏览器中拖拽排序的已知问题
 */
const imgDrop = (uid) => {
