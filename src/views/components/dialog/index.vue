    ...
    <template #header>
      <div class="card-header">
        <span class="font-medium">
          采用函数式调用弹框组件二次封装 Element Plus 的
          <el-link
...
function onFullscreenClick() {
  addDialog({
    title: '全屏',
    fullscreen: true,
    // createVNode 渲染函数 https://cn.vuejs.org/guide/extras/render-function.html#creating-vnodes
    contentRenderer: () => createVNode('p', null, '弹框内容-全屏'),
  })
}
...
// 演示嵌套写法，实际情况下最好把 addDialog 函数抽出来
