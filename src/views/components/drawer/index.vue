  ...
  <el-card shadow="always">
    <template #header>
      <div class="card-header">
        <span class="font-medium"> 采用函数式调用 Drawer,二次封装 Element Plus 的 </span>
      </div>
    </template>
    <el-space wrap>
...
import { addDrawer, closeDrawer, closeAllDrawer, updateDrawer } from '@/components/YeDrawer/index.ts'
...
// 演示嵌套写法，实际情况下最好把 addDrawer 函数抽出来
